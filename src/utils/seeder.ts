...
const adminSeeder = async (email: string, code: string) => {
...
const seedDatabase = async () => {
  try {
    ...
    // await dropDatabase();
    await Promise.all([
      adminSeeder('admin@gmail.com', 'ADMIN1'),
      adminSeeder('mamun@gmail.com', 'ADMIN2'),
      adminSeeder('sagor@gmail.com', 'ADMIN3'),
      SettingSeeder(),
    ]);
